...
- To manage the state of the forms, the application uses an rtk slice called "editor" and a special "useEditorSlice" hook
...
3. Run docker run, specify environment variables in the command, for example:
   - docker run -d -p 3000:3000 -e VITE_PUBLIC_URL=http://localhost:5000 frontend
